package it.aman.covidnotanumber.aspect;
...
import it.aman.covidnotanumber.util.LogConstants.LogLevel;
...
public class EthLoggerAspect {
	...
	@Around("@annotation(it.aman.covidnotanumber.annotations.EthLoggable)") //or add EthLogger as a param with jointPoint
